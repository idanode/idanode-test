...
const creation_message = "Giac mo bat dau tu day!，Dream begins here!"

var genesisConfigData = {};
var witnesses = [];
var allAddress = [];
var arrOutputs = [
    {address: "IO3JFSLJQVS4GNWR6I4QYIPBYGIUF3ZF", amount: 0 } //First, change the address
];
...
eventBus.once('headless_wallet_ready', function() {
    console.log("Create a creation unit");
    rungen();
}
);
